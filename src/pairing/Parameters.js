...
class Parameters {
    constructor(fieldBits) {
        if (arguments.length === 1) {
            ...
            switch (fieldBits) {
                case 27:
                    this.u = bigInt(-41n) // debugging only
                    break
                case 48:
                ...
                case 158:
                    this.b = 2
                    this.u = bigInt(
                        '100000000000000100000000000000000100011',
                        2
                    )
                ...
                case 160:
                    this.u = bigInt(
                        '-110010001000000010000000000000001000001',
                        2
                    )
                    break
                case 168:
                    this.u = bigInt(
                        '-11001000000000000000000010000001000000001',
                        2
                    )
                    break
                case 176:
                    this.u = bigInt(
                        '-1100100100000000000000000010000000000000001',
                        2
                    )
                    break
                case 184:
                    this.u = bigInt(
                        '-110000001100000000000000000000001000000000001',
                        2
                    )
                    break
                ...
                case 192:
                    this.u = bigInt(
                        '-11000000000000000000010010000000000010000000001',
                        2
                    )
                    break
                case 200:
                    this.u = bigInt(
                        '-1101000000000000000000001000000000000010000000001',
                        2
                    )
                    break
                case 208:
                ...
                case 216:
                    this.u = bigInt(
                        '-11000000000000000010000000000000000000000000000000001',
                        2
                    )
                    break
                ...
                case 224:
                    this.u = bigInt(
                        '-1100000100000000000000000010000000100000000000000000001',
                        2
                    )
                    break
                case 232:
                ...
                default:
                    throw new Error(
                        invalidParams +
                            ': Field size in bits must be a multiple of 8 between 48 and 512'
                    )
            }

            this.p = bigInt(36n)
                .multiply(this.u.pow(this._4))
                .add(bigInt(36).multiply(this.u.pow(bigInt(3))))
                .add(bigInt(24).multiply(this.u.pow(bigInt(2))))
                .add(this._6.multiply(this.u))
                .add(this._1)
            ...
            this.rho = this._6
                ...
                .multiply(
                    this._3
                        .multiply(this.u)
                        .multiply(this.u.shiftLeft(1).add(this._1))
                        .add(this._1)
                )
                .add(this._1)
            ...
            this.sqrtExponent2 = this.p
                .multiply(this.p)
                .add(this._7)
                .shiftRight(4)

            this.cbrtExponent2 = this.p
                .multiply(this.p)
                .add(this._2)
                .divide(this._9)
            this.sigma = this.p
                ...
                .modPow(
                    this.p
                        .subtract(this._1)
                        .subtract(this.p.add(this._5).divide(this._24)),
                    this.p
                )
    ...
    sqrt(v) {
        ...
        if (ExNumber.testBit(this.p, 1)) {
            ...
            return ExNumber.signum(r.multiply(r).subtract(v).mod(this.p)) === 0
                ? r
                : null
        }
        ...
        if (ExNumber.testBit(this.p, 2)) {
            ...
            return r.multiply(r).subtract(v).mod(this.p).signum() === 0
                ? r
                : null
        }
        ...
        let r = this.lucas(z, this.p.shiftRight(2))
            .multiply(t.modInverse(this.p))
            .mod(this.p)
